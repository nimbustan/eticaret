...
SECRET_KEY = '@rqeq03nj((055b8xycmc8@*r$(mt-ng8!xjki8ry%6*^=g__&'
...
MEDIA_ROOT = os.path.join(BASE_DIR, '../eticaret_media')
STATIC_ROOT = os.path.join(BASE_DIR, '../eticaret_static')
